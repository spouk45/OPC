...
/**
 * @ORM\Entity(repositoryClass="App\Repository\HeatingSourceRepository")
 */
class HeatingSource
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Heating", mappedBy="sourceType")
     */
    private $heatings;
    ...
    public function removeHeating(Heating $heating): self
    {
        if ($this->heatings->contains($heating)) {
            ...
            if ($heating->getSourceType() === $this) {
                $heating->setSourceType(null);
            }
        }
