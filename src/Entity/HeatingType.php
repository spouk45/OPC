...
/**
 * @ORM\Entity(repositoryClass="App\Repository\HeatingTypeRepository")
 */
class HeatingType
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Heating", mappedBy="heatingType")
     */
    private $heatings;
    ...
    public function removeHeating(Heating $heating): self
    {
        if ($this->heatings->contains($heating)) {
            ...
            if ($heating->getHeatingType() === $this) {
                $heating->setHeatingType(null);
            }
        }
